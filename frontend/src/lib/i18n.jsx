...
const messages = {
  en: {
    ...
    home: {
      ...
      premiumTitle: "Project highlights",
      premiumList: [
        "Use searchable OCR and scan-to-PDF workflows directly in the browser.",
        "Protect PDFs with AES-256 encryption and stronger file validation.",
        "Save workflow presets locally and reuse them during your project demo.",
      ],
      premiumButton: "Explore features",
  ...
  es: {
    ...
    home: {
      ...
      premiumTitle: "Aspectos destacados del proyecto",
      premiumButton: "Explorar funciones",
  ...
  fr: {
    ...
    home: {
      ...
      filters: {
        ...
        convert: "Convertir PDF",
        edit: "Editer PDF",
        security: "Securite PDF",
        intelligence: "Intelligence PDF",
      },
      workTitle: "Travaillez a votre facon",
      premiumTitle: "Points forts du projet",
      premiumButton: "Explorer les fonctionnalites",
  ...
  ar: {
    ...
    home: {
      ...
      premiumTitle: "ابرز مزايا المشروع",
  ...
  hi: {
    ...
    home: {
      ...
      filters: {
        all: "सभी",
        workflow: "वर्कफ्लो",
        organize: "ऑर्गनाइज PDF",
        optimize: "ऑप्टिमाइज़ PDF",
        convert: "कन्वर्ट PDF",
        edit: "एडिट PDF",
        security: "PDF सिक्योरिटी",
        intelligence: "PDF इंटेलिजेंस",
      },
      workTitle: "अपने तरीके से काम करें",
      premiumTitle: "प्रोजेक्ट की खास खूबियां",
  ...
  ur: {
    ...
    home: {
      ...
      filters: {
        all: "سب",
        workflow: "ورک فلو",
        organize: "آرگنائز PDF",
        optimize: "آپٹمائز PDF",
        convert: "کنورٹ PDF",
        edit: "ایڈٹ PDF",
        security: "PDF سیکیورٹی",
        intelligence: "PDF انٹیلیجنس",
      },
      workTitle: "اپنے انداز میں کام کریں",
      premiumTitle: "پروجیکٹ کی نمایاں خصوصیات",
